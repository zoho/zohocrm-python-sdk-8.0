...
from zohocrmsdk.src.com.zoho.crm.api.contact_roles import ContactRolesOperations, BodyWrapper, ContactRole, ActionWrapper, APIException
...
class UpdateContactRole(object):
    ...
    def update_contact_role(contact_role_id):
        """
        This method is used to update a specific Contact Role and print the response.
        ...
        contact_role.set_name("Updated Single Role")
        contact_role.set_sequence_number(2)
...
UpdateContactRole.update_contact_role(1055806000013538010)