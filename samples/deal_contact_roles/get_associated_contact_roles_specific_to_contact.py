...
class GetAssociatedContactRolesSpecificToContact:
    ...
    @staticmethod
    def get_associated_contact_roles_specific_to_contact(deal_id, contact_id):
        try:
            deal_contact_roles_operations = DealContactRolesOperations()
            response = deal_contact_roles_operations.get_associated_contact_roles_specific_to_contact(contact_id,
                                                                                                      deal_id)
...
GetAssociatedContactRolesSpecificToContact.initialize()
GetAssociatedContactRolesSpecificToContact.get_associated_contact_roles_specific_to_contact(1055806000028482009, 1055806000028482004)