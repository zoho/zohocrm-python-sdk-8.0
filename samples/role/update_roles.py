...
class UpdateRoles:
    ...
    def update_roles():
        """
        This method is used to update roles and print the response.
        """
        try:
            ...
            role = Role()
            role.set_id(44024801431002)
            role.set_name("Updated Role Name")
            role.set_display_label("Updated Role Display Label")
            role.set_description("Updated role description")
            role.set_share_with_peers(False)
            ...
            response = roles_operations.update_roles(request)
            ...
            print("Exception in update_roles: " + str(e))
