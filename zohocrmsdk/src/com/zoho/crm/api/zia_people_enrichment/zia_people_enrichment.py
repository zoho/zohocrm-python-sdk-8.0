...
class ZiaPeopleEnrichment(object):
	def __init__(self):
		"""Creates an instance of ZiaPeopleEnrichment"""
	...
	def set_created_by(self, created_by):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.user import User
		except Exception:
	...
	def set_enriched_data(self, enriched_data):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.zia_people_enrichment.enriched_data import EnrichedData
		except Exception:
