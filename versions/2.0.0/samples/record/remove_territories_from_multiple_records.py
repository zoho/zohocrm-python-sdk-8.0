...
class RemoveTerritoriesFromMultipleRecords:
    ...
    def remove_territories_from_multiple_records(module_api_name):
        ...
        # Call remove_territories_from_multiple_records method that takes module_api_name and BodyWrapper instance as
        # parameter
        response = record_operations.remove_territories_from_multiple_records(request)
...
RemoveTerritoriesFromMultipleRecords.remove_territories_from_multiple_records(module_api_name)