...
class UpdateSharePermissions:
    ...
    @staticmethod
    def update_share_permissions(record_id, module_api_name):
        """
        This method is used to update permissions for a shared record.
        
        Args:
            record_id (str): The ID of the record to update share permissions for
        ...
        try:
            ...
            share_record.set_permission("read_only")  # Change from "read_write" to "read_only"
            share_record.set_share_related_records(False)  # Update to not share related records
            user = Users()
            ...
            shared_with.add_key_value("type", "groups")  # or "users"
...
UpdateSharePermissions.update_share_permissions(1055806000028347001, "Leads")