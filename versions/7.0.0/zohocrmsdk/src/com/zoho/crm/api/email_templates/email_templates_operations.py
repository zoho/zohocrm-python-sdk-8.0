...
class GetEmailTemplatesParam(object):
	...
	category = Param('category', 'com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam')
	sort_by = Param('sort_by', 'com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam')
	sort_order = Param('sort_order', 'com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam')
	filters = Param('filters', 'com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam')
