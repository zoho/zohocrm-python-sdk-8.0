...
class Fields(object):
	def __init__(self):
		...
		self.__auto_number_61 = None
		self.__pick_list_values = None
		self.__crypt = None
		self.__tooltip = None
		self.__history_tracking_enabled = None
		...
		self.__update_existing_records = None
	...
	def set_operation_type(self, operation_type):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.operation_type import OperationType
		except Exception:
	...
	def set_email_parser(self, email_parser):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.email_parser import EmailParser
		except Exception:
	...
	def set_rollup_summary(self, rollup_summary):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.rollup_summary import RollupSummary
		except Exception:
	...
	def set_refer_from_field(self, refer_from_field):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.refer_from_field import ReferFromField
		except Exception:
	...
	def set_multi_module_lookup(self, multi_module_lookup):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.multi_module_lookup import MultiModuleLookup
		except Exception:
	...
	def set_sharing_properties(self, sharing_properties):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.modules import SharingProperties
		except Exception:
			from ..modules import SharingProperties
	...
	def set_currency(self, currency):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.currency import Currency
		except Exception:
	...
	def set_lookup(self, lookup):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.lookup import Lookup
		except Exception:
	...
	def set_view_type(self, view_type):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.view_type import ViewType
		except Exception:
	...
	def set_unique(self, unique):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.unique import Unique
		except Exception:
	...
	def set_subform(self, subform):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.subform import Subform
		except Exception:
	...
	def set_external(self, external):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.external import External
		except Exception:
	...
	def set_formula(self, formula):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.formula import Formula
		except Exception:
	...
	def set_private(self, private):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.private import Private
		except Exception:
	...
	def set_convert_mapping(self, convert_mapping):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.convert_mapping import ConvertMapping
		except Exception:
	...
	def set_multiselectlookup(self, multiselectlookup):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.multiselectlookup import Multiselectlookup
		except Exception:
	...
	def set_autonumber(self, autonumber):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.auto_number import AutoNumber
		except Exception:
	...
	def get_auto_number_61(self):
		...
		return self.__auto_number_61

	def set_auto_number_61(self, auto_number_61):
		"""
		The method to set the value to auto_number_61

		Parameters:
			auto_number_61 (AutoNumber) : An instance of AutoNumber
		"""
		...
		if auto_number_61 is not None and not isinstance(auto_number_61, AutoNumber):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: auto_number_61 EXPECTED TYPE: AutoNumber', None, None)
		
		self.__auto_number_61 = auto_number_61
	...
	def set_crypt(self, crypt):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.crypt import Crypt
		except Exception:
	...
	def set_tooltip(self, tooltip):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.tooltip import Tooltip
		except Exception:
	...
	def get_history_tracking_enabled(self):
		"""
		The method to get the history_tracking_enabled

		Returns:
			bool: A bool representing the history_tracking_enabled
		"""

		return self.__history_tracking_enabled

	def set_history_tracking_enabled(self, history_tracking_enabled):
		"""
		The method to set the value to history_tracking_enabled

		Parameters:
			history_tracking_enabled (bool) : A bool representing the history_tracking_enabled
		"""

		if history_tracking_enabled is not None and not isinstance(history_tracking_enabled, bool):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: history_tracking_enabled EXPECTED TYPE: bool', None, None)
		
		self.__history_tracking_enabled = history_tracking_enabled
		self.__key_modified['history_tracking_enabled'] = 1
	...
	def set_history_tracking(self, history_tracking):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.history_tracking import HistoryTracking
		except Exception:
	...
	def set_association_details(self, association_details):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.association_details import AssociationDetails
		except Exception:
	...
	def get_global_picklist(self):
		...
		Returns:
			Picklist: An instance of Picklist
		"""
	...
	def set_global_picklist(self, global_picklist):
		...
		Parameters:
			global_picklist (Picklist) : An instance of Picklist
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.global_picklists import Picklist
		except Exception:
			from ..global_picklists import Picklist

		if global_picklist is not None and not isinstance(global_picklist, Picklist):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: global_picklist EXPECTED TYPE: Picklist', None, None)
	...
	def set_hipaa_compliance(self, hipaa_compliance):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.hipaa_compliance import HipaaCompliance
		except Exception:
	...
	def get_update_existing_records(self):
		"""
		The method to get the update_existing_records

		Returns:
			bool: A bool representing the update_existing_records
		"""

		return self.__update_existing_records

	def set_update_existing_records(self, update_existing_records):
		"""
		The method to set the value to update_existing_records

		Parameters:
			update_existing_records (bool) : A bool representing the update_existing_records
		"""

		if update_existing_records is not None and not isinstance(update_existing_records, bool):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: update_existing_records EXPECTED TYPE: bool', None, None)
		
		self.__update_existing_records = update_existing_records
	...
	def set_textarea(self, textarea):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.fields.textarea import Textarea
		except Exception:
