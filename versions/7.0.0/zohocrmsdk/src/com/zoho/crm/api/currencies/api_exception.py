try:
	...
	from zohocrmsdk.src.com.zoho.crm.api.currencies.base_currency_action_response import BaseCurrencyActionResponse
	from zohocrmsdk.src.com.zoho.crm.api.currencies.action_response import ActionResponse
...
class APIException(ActionResponse, BaseCurrencyActionResponse, ResponseHandler, ActionHandler):
	def __init__(self):
