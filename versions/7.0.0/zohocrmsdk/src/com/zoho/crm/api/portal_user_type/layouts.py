...
class Layouts(object):
	...
	def set_default_view(self, default_view):
		...
		Parameters:
			default_view (Views) : An instance of Views
		"""
		...
		if default_view is not None and not isinstance(default_view, Views):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: default_view EXPECTED TYPE: Views', None, None)
