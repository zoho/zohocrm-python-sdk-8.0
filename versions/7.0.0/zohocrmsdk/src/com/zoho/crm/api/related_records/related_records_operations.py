...
class GetRelatedRecordsParam(object):
	...
	ids = Param('ids', 'com.zoho.crm.api.RelatedRecords.GetRelatedRecordsParam')
...
class GetRelatedRecordsUsingExternalIDParam(object):
	...
	ids = Param('ids', 'com.zoho.crm.api.RelatedRecords.GetRelatedRecordsUsingExternalIDParam')
