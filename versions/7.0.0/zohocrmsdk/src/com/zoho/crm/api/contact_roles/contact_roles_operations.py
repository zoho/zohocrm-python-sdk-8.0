...
class ContactRolesOperations(object):
	...
	def get_roles(self):
		...
		api_path = ''
		api_path = api_path + '/crm/v8/Contacts/roles'
		handler_instance.set_api_path(api_path)
		handler_instance.set_http_method(Constants.REQUEST_METHOD_GET)
		handler_instance.set_category_method(Constants.REQUEST_CATEGORY_READ)
		try:
			from zohocrmsdk.src.com.zoho.crm.api.contact_roles.response_handler import ResponseHandler
		except Exception:
	...
	def create_roles(self, request):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.contact_roles.body_wrapper import BodyWrapper
		except Exception:
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.contact_roles.action_handler import ActionHandler
		except Exception:
