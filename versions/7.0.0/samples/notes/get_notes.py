...
from zohocrmsdk.src.com.zoho.crm.api.notes import NotesOperations, GetNotesParam, GetNotesHeader
...
class GetNotes:
    ...
    def get_notes():
        try:
            ...
            param_instance.add(GetNotesParam.per_page, "20")
            param_instance.add(GetNotesParam.fields, "Note_Title,Note_Content")
            
            header_instance = HeaderMap()
            header_instance.add(GetNotesHeader.if_modified_since, datetime(2020, 1, 1, 10, 0, 0))
            ...
            if response is not None:
                ...
                if response_object is not None:
                    if isinstance(response_object, ResponseWrapper):
                        ...
                        if info is not None:
                            print("Notes Info Count: " + str(info.get_count()))
                            print("Notes Info Page: " + str(info.get_page()))
                            print("Notes Info PerPage: " + str(info.get_per_page()))
                            print("Notes Info MoreRecords: " + str(info.get_more_records()))
            ...
            print("Exception when calling get_notes: " + str(e))
