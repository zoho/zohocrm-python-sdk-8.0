...
from zohocrmsdk.src.com.zoho.crm.api.notes import NotesOperations, DeleteNotesParam,SuccessResponse
...
class DeleteNotes:
    ...
    def delete_notes():
        try:
            ...
            note_ids = [1055806000028563002, 1055806000028209028, 1055806000028209029]
            param_instance.add(DeleteNotesParam.ids, ",".join(map(str, note_ids)))
            ...
            print("Exception when calling delete_notes: " + str(e))
