...
from zohocrmsdk.src.com.zoho.crm.api.layouts import LayoutsOperations, GetLayoutParam
...
class GetLayout:
    ...
    def get_layout(layout_id):
        try:
            ...
            param_instance.add(GetLayoutParam.module, "Leads")
            response = layouts_operations.get_layout(layout_id, param_instance)
            ...
            print("Exception when calling get_layout: " + str(e))


GetLayout.initialize()
GetLayout.get_layout(1055806000000091055)