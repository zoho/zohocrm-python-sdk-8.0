...
from zohocrmsdk.src.com.zoho.crm.api.related_records import RelatedRecordsOperations, GetRelatedRecordsParam, \
    GetRelatedRecordsHeader, ResponseWrapper, APIException
...
class GetRelatedRecords:
    ...
    def get_related_records(module_api_name, record_id, related_list_api_name):
        ...
        :param record_id: The ID of the record to be obtained related records
        ...
        param_instance.add(GetRelatedRecordsParam.fields, "id")
        header_instance = HeaderMap()
        # Possible headers for Get Related Records operation
        header_instance.add(GetRelatedRecordsHeader.if_modified_since,
                            datetime.fromisoformat('2019-10-15T05:00:00+05:30'))
        # Call get_related_records method that takes record_id, ParameterMap instance and HeaderMap instance as
        # parameter
...
GetRelatedRecords.get_related_records(module_api_name="Leads", record_id=4402480774074, related_list_api_name="Notes")
