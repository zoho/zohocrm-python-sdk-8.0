...
class UpdateTerritories:
    ...
    def update_territories():
        ...
        try:
            ...
            # Update first territory
            territory1 = Territories()
            territory1.set_id(1055806000000394043)  # Replace with actual territory ID
            territory1.set_name("Updated Territory 1")
            territory1.set_description("Updated description for Territory 1")
            territories_list.append(territory1)
            
            # Update second territory
            territory2 = Territories()
            territory2.set_id(1055806000000394044)  # Replace with actual territory ID
            territory2.set_name("Updated Territory 2")
            territory2.set_description("Updated description for Territory 2")
            territories_list.append(territory2)
            
            request.set_territories(territories_list)
            response = territories_operations.update_territories(request)
            ...
            print(f"Error in update_territories: {e}")


UpdateTerritories.initialize()
UpdateTerritories.update_territories()