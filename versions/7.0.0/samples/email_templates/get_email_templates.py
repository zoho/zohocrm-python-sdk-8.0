...
from zohocrmsdk.src.com.zoho.crm.api.email_templates import EmailTemplatesOperations, GetEmailTemplatesParam
...
class GetEmailTemplates:
    ...
    def get_email_templates():
        try:
            ...
            param_instance.add(GetEmailTemplatesParam.module, "Leads")
            ...
            print("Exception when calling get_email_templates: " + str(e))


GetEmailTemplates.initialize()
GetEmailTemplates.get_email_templates()
