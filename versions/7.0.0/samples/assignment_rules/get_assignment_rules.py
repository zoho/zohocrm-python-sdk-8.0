...
from zohocrmsdk.src.com.zoho.crm.api.assignment_rules.assignment_rules_operations import AssignmentRulesOperations, GetAssignmentRulesParam
...
class GetAssignmentRules:
    ...
    def get_assignment_rules():
        ...
        param_instance.add(GetAssignmentRulesParam.module, "Leads")
        response = assignment_rules_operations.get_assignment_rules(param_instance)
