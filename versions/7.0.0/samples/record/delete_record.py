...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, DeleteRecordParam, ActionWrapper, \
...
class DeleteRecord:
    ...
    def delete_record(module_api_name, record_id):
        ...
        # header_instance.add(DeleteRecordHeader.x_external, "Leads.External") Call deleteRecord method that takes
        # record_id, module_api_name, param_instance and header_instance as parameter.
...
DeleteRecord.delete_record(module_api_name="Leads", record_id=44028001776017)
