...
class GetModule:
    ...
    def get_module(module_id):
        """
        This method is used to get metadata about single module with its API Name and print the response.
        :param module_id: The API Name of the module to obtain metadata
        """
        """
        example
...
GetModule.get_module(module_id=34775367)
