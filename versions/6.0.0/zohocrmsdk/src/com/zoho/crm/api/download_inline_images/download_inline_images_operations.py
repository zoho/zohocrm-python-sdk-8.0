...
class DownloadInlineImagesOperations(object):
	def __init__(self):
		"""Creates an instance of DownloadInlineImagesOperations"""
		pass

	def get_download_inline_images(self, record_id, module, param_instance=None):
		"""
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.download_inline_images.response_handler import ResponseHandler
		except Exception:
			from .response_handler import ResponseHandler
		return handler_instance.api_call(ResponseHandler.__module__, 'multipart/form-data')


class GetDownloadInlineImagesParam(object):
	user_id = Param('user_id', 'com.zoho.crm.api.DownloadInlineImages.GetDownloadInlineImagesParam')
	message_id = Param('message_id', 'com.zoho.crm.api.DownloadInlineImages.GetDownloadInlineImagesParam')
