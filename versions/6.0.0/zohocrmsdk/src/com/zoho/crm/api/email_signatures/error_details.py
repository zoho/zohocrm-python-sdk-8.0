...
class ErrorDetails(object):
	...
	def set_range(self, range):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.email_signatures.range_structure import RangeStructure
		except Exception:
	...
	def get_param_name(self):
		...
		Returns:
			string: A string representing the param_name
		"""
	...
	def set_param_name(self, param_name):
		...
		Parameters:
			param_name (string) : A string representing the param_name
		"""

		if param_name is not None and not isinstance(param_name, str):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: param_name EXPECTED TYPE: str', None, None)
		
		self.__param_name = param_name
		self.__key_modified['param_name'] = 1
