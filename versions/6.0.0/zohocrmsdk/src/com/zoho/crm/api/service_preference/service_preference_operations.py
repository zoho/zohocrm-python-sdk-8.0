...
class ServicePreferenceOperations(object):
	def __init__(self):
		"""Creates an instance of ServicePreferenceOperations"""
		pass

	def get_service_preference(self):
		"""
		...
		api_path = ''
		api_path = api_path + '/crm/v8/settings/service_preferences'
	...
	def update_service_preference(self, request):
		"""
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.service_preference.body_wrapper import BodyWrapper
		except Exception:
