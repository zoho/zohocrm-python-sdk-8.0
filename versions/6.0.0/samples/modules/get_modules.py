...
from zohocrmsdk.src.com.zoho.crm.api.modules import ModulesOperations, GetModulesHeader, ResponseWrapper, APIException, \
    GetModulesParam
...
class GetModules:
    ...
    def get_modules():
        ...
        parameter_instance = ParameterMap()
        parameter_instance.add(GetModulesParam.status, Choice("user_hidden"))
        ...
        response = modules_operations.get_modules(param_instance=parameter_instance, header_instance=header_instance)
            ...
            if response_object is not None:
                if isinstance(response_object, ResponseWrapper):
                    ...
                    for module in modules_list:
                        ...
                        print("Module Is blueprint supported: " + str(bool(module.get_isblueprintsupported())))
                        ...
                        print("Module Is Web form Supported: " + str(bool(module.get_webform_supported())))
