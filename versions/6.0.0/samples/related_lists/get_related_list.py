...
class GetRelatedList(object):
    ...
    @staticmethod
    def get_related_list(related_list_id, layout_id=None):
        """
        ...
        :param layout_id: The ID of the layout to get related list
        """
        try:
            related_lists_operations = RelatedListsOperations(layout_id)
            param_instance = ParameterMap()
            param_instance.add(GetRelatedListParam.module, "Leads")
            ...
            print("Exception in get_related_list: " + str(e))


GetRelatedList.initialize()
GetRelatedList.get_related_list(1055806000027545142)