...
from zohocrmsdk.src.com.zoho.crm.api.tags import TagsOperations, NewTagRequestWrapper, Tag, RecordActionWrapper, RecordSuccessResponse, APIException, AddTagsParam
...
class AddTagsToRecord:
    ...
    def add_tags_to_record(module_api_name, record_id):
        """
        This method is used to add tags to a record and print the response.
        ...
        try:
            ...
            param_instance.add(AddTagsParam.over_write, "false")
            ...
            print("Exception in add_tags_to_record: " + str(e))


AddTagsToRecord.initialize()
AddTagsToRecord.add_tags_to_record("Leads", 1055806000028448052)