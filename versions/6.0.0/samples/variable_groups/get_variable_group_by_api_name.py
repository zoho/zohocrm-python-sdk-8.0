...
class GetVariableGroupByApiName:
    ...
    def get_variable_group_by_api_name(api_name):
        """
        Get specific variable group by API name
        
        Args:
            api_name (str): The API name of the variable group to retrieve
        ...
        try:
            ...
            response = variable_groups_operations.get_variable_group_by_api_name(api_name)
            ...
            print(f"Error in get_variable_group_by_api_name: {e}")


api_name = "General"

GetVariableGroupByApiName.initialize()
GetVariableGroupByApiName.get_variable_group_by_api_name(api_name)