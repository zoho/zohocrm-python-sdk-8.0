...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, GetRecordParam, GetRecordHeader, ResponseWrapper, \
    FileDetails, Reminder, Participants, ImageUpload, PricingDetails, Record, LineTax, Comment, RemindAt, \
    RecurringActivity, Consent, FileBodyWrapper, APIException
...
class GetRecordUsingExternalId:
    ...
    def get_record_using_external_id(module_api_name, external_field_value, destination_folder):
        ...
        # Call get_record_using_external_id method that takes external_field_value, module_api_name, param_instance
        # and header_instance as parameter
        response = record_operations.get_record_using_external_id(external_field_value, param_instance, header_instance)
...
GetRecordUsingExternalId.get_record_using_external_id(module_api_name="Leads", external_field_value="3342343242423",
                                                      destination_folder="users/document/file")
