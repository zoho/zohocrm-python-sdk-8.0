...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, GetRecordsParam, GetRecordsHeader, \
    ResponseWrapper, FileDetails, Reminder, Participants, ImageUpload, PricingDetails, Record, LineTax, Comment, \
    RemindAt, RecurringActivity, Consent, APIException
...
GetRecords.get_records(module_api_name="Leads")
