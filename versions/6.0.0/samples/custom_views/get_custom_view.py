...
from zohocrmsdk.src.com.zoho.crm.api.custom_views import CustomViewsOperations, GetCustomViewParam
...
class GetCustomView:
    ...
    @staticmethod
    def get_custom_view(custom_view_id):
        try:
            custom_views_operations = CustomViewsOperations()
            param_instance = ParameterMap()
            param_instance.add(GetCustomViewParam.module, "Leads")
                    ...
                    if isinstance(response_object, ResponseWrapper):
                        ...
                        for custom_view in custom_views_list:
                            ...
                            if criteria is not None:
                                print("CustomView Criteria Comparator: " + str(criteria.get_comparator()))
            ...
            print("Exception when calling get_custom_view: " + str(e))


GetCustomView.initialize()
GetCustomView.get_custom_view(1055806000020849005)