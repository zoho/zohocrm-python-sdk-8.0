...
class EnableBaseCurrency:
    ...
    def enable_base_currency():
        try:
            ...
            response = currencies_operations.enable_base_currency(request)
            ...
            print("Exception when calling enable_base_currency: " + str(e))


EnableBaseCurrency.initialize()
EnableBaseCurrency.enable_base_currency()