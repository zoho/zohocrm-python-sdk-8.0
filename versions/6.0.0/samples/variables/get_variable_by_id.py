...
from zohocrmsdk.src.com.zoho.crm.api.variables import (
    VariablesOperations, ResponseWrapper, APIException, GetVariableByIDParam
)
...
class GetVariableByID:
    ...
    def get_variable_by_id(variable_id):
        ...
        try:
            ...
            # Optional parameters
            # param_instance.add(GetVariableByIDParam.group, "General")
            ...
            print(f"Error in get_variable_by_id: {e}")


GetVariableByID.initialize()
GetVariableByID.get_variable_by_id(1055806000028506016)