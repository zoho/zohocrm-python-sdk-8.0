...
class UpdatePipeline:
    ...
    @staticmethod
    def update_pipeline(layout_id, pipeline_id):
        """
        This method is used to update a specific pipeline for a layout and print the response.
        ...
        try:
            ...
            pipeline = Pipeline()
            pipeline.set_display_value("Updated Pipeline Name21")
            ...
            print("Exception when calling update_pipeline: " + str(e))


UpdatePipeline.initialize()
UpdatePipeline.update_pipeline(layout_id=1055806000000091023, pipeline_id=1055806000029084005)
