...
class GetPipelines:
    ...
    def get_pipelines(layout_id):
        """
        This method is used to get all pipelines for a layout and print the response.
        ...
        try:
            ...
            print("Exception when calling get_pipelines: " + str(e))


GetPipelines.initialize()
GetPipelines.get_pipelines(layout_id=1055806000000091023)
