...
from zohocrmsdk.src.com.zoho.crm.api.record import FileDetails, Reminder, Participants, PricingDetails, Record, \
    LineTax, Comment, RemindAt, RecurringActivity, Consent
from zohocrmsdk.src.com.zoho.crm.api.related_records import RelatedRecordsOperations, \
    ResponseWrapper, FileBodyWrapper, APIException, GetRelatedRecordUsingExternalIDHeader
...
class GetRelatedRecordUsingExternalId:
    ...
    @staticmethod
    def get_related_record_using_external_id(module_api_name, external_value, related_list_api_name,
        ...
        header_instance.add(GetRelatedRecordUsingExternalIDHeader.if_modified_since,
                            datetime.fromisoformat('2019-10-15T05:00:00+05:30'))
        header_instance.add(GetRelatedRecordUsingExternalIDHeader.x_external, x_external)
        response = related_records_operations.get_related_record_using_external_id(external_field_value,
                                                                                   external_value, param_instance,
                                                                                   header_instance)
                                ...
                                if len(value) > 0:
                                    if isinstance(value[0], FileDetails):
                                        ...
                                        for file_detail in file_details:
                                            ...
                                            print("RelatedRecord FileDetails IsPreviewAvailable: " +
                                                  str(file_detail.get_is_preview_available()))
                                            print("RelatedRecord FileDetails DownloadUrl: " +
                                                  file_detail.get_download_url())
                                            print("RelatedRecord FileDetails DeleteUrl: " +
                                                  file_detail.get_delete_url())
                                            ...
                                            print("RelatedRecord FileDetails CreatorId: " +
                                                  file_detail.get_creator_id())
                                        ...
                                        for participant in participants:
                                            ...
                                            print("RelatedRecord Participants Invited: " +
                                                  str(participant.get_invited()))
                                        ...
                                        for pricing_detail in pricing_details:
                                            print("RelatedRecord PricingDetails ToRange: " +
                                                  str(pricing_detail.get_to_range()))
                                            print("RelatedRecord PricingDetails Discount: " +
                                                  str(pricing_detail.get_discount()))
                                            print("RelatedRecord PricingDetails ID: " + str(pricing_detail.get_id()))
                                            print("RelatedRecord PricingDetails FromRange: " +
                                                  str(pricing_detail.get_from_range()))
                                        ...
                                        for attachment in attachments:
                                            ...
                                            print("Record Attachment Modified Time: " +
                                                  str(attachment.get_modified_time()))
                                            print("Record Attachment File Name: " + attachment.get_file_name())
                                            print("Record Attachment Created Time: " +
                                                  str(attachment.get_created_time()))
                                            ...
                                            if modified_by is not None:
                                                ...
                                                print("Record Attachment Modified By - Email: " +
...
GetRelatedRecordUsingExternalId.get_related_record_using_external_id(module_api_name="Leads", external_value="external",
