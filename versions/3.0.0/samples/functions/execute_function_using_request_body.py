...
from zohocrmsdk.src.com.zoho.crm.api.functions import BodyWrapper
...
class ExecuteFunctionUsingRequestBody:
    ...
    @staticmethod
    def execute_function_using_request_body():
        ...
        requestBody = dict()
        requestBody["name"] = "JavaScript"
        requestBody["version"] = "4.0.0"

        sample = dict()
        sample["name"] = "JAVASCRIPT-2.1"
        sample["version"] = "1.0.0"

        requestBody["v2.1"] = sample

        body_wrapper.set_body(requestBody)
        ...
        response = functionsOperations.execute_function_using_request_body(body_wrapper, paramInstance, headerInstance)
...
ExecuteFunctionUsingRequestBody.execute_function_using_request_body()
